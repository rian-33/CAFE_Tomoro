// 1. Import gambarnya satu per satu dari folder assets
// Tanda "../" artinya kita keluar dulu dari folder 'components', lalu masuk ke 'assets'
    ...
    <section id="suasana" className="suasana-section">
      ...
      <div className="suasana-grid">
        <div className="grid-item">
          {/* 2. Gunakan kurung kurawal {} untuk memanggil gambar yang sudah di-import */}
